<template>
  <view class="container">
    ...
    <uni-card v-show="includesZhu(GlobalData.curent_title)" :is-shadow="false">
    ...
    <view v-show="includesZhu(GlobalData.curent_title)" class="example">
  ...
  <button v-show="includesZhu(GlobalData.curent_title)" class="server-btn" @click="handleItemClick">发布</button>
